...
function renderPromotions(container, template, collection){
    ...
    $.each( collection , function( key, val ) {
        ...
        if(val.promo_image_url_abs.indexOf('missing.png') > 0){
            // val.promo_image_url_abs  = "//codecloud.cdn.speedyrails.net/sites/586c10926e6f6440cb000000/image/jpeg/1495128383000/quinte_default.jpg";
        }
...
function load_map(reg, stores){
    ...
    map = $('#mapsvg_store_list').mapSvg({
        ...
        colors: {stroke: '#aaaaaa', selected: -20, hover: "#f57b2b"},
        disableAll: true,
        regions: reg,
        tooltipsMode: 'custom',
        loadingText: "loading...",
